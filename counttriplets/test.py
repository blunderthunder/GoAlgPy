...
if __name__ == '__main__':
    t1 = timeit.timeit("countTriplets([12,5,24,48,96, 48], 2)", setup="from __main__ import countTriplets", number=10000)

    t2 = timeit.timeit("countTripletsv1([12,5,24,48,96, 48], 2)", setup="from __main__ import countTripletsv1", number=10000)
